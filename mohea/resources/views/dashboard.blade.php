...
<main class="dashboard">
    <div class="profile">
        <div class="my-card">
            ...
            <a class="button icon ml-auto" href="{{ route('user.info') }}" title="Edit your account"><i class="fas fa-user-edit"></i></a>
        </div>
    </div>
    <div class="content">
        ...
        <div class="create">
            ...
            <a class="button primary" href="{{ route('project.create') }}">New project</a>
        </div>
