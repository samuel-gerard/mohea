...
import { deleteItem, updateElement } from "../redux/actions";
            ...
            <div>
                {this.props.focus > -1 ? (
                    <div>
                        ...
                        <input type="button" onClick={() => this.handleDeleteItem(this.props.elementsUsed[this.props.focus])} className="btn btn-primary" value="Duplicate Element" />
